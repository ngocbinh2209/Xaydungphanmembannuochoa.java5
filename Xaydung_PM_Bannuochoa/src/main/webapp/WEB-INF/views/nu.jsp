								...
								<div class="col-12">
									<div class="main_menu_inner">
										<div class="main_menu d-none d-lg-block">
											<nav>
												<ul>
													<li class=""><a href="/perfume/home">Trang
															Chủ</a></li>
													...
													<li class="contact-us"><a href="/perfume/login">Đăng
														...
														<li><a href="/perfume/logout" title="logouut">Đăng Xuất</a></li>
																</ul>
															</div>
														</div></li>
						...
						<div class="row">
							<div class="col-12">
								<div class="breadcrumb_content">
									<ul>
										<li><a href="index.html">Nước Hoa Nữ</a></li>
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="banner_slider fullwidht  mb-35">
									<img src="/assets/img/banner/bannner12.jpg" alt="">
								</div>
								<!--banner slider start-->
							</div>
						</div>
									...
									<div class="select_option">
										<form action="#">
											<label>Sắp xếp</label> <select name="orderby" id="short">
												...
												<option value="1">Sắp Xếp Theo Giá:Thấp</option>
												<option value="1">Sắp Xếp Theo Giá:Cao</option>
												<option value="1">Tên Sản Phẩm: Z</option>
						...
						<div class="shop_tab_product shop_fullwidth">
							<div class="tab-content" id="myTabContent">
										...
										<div class="row align-items-center">
											...
											<div class="col-lg-9 col-md-7 col-sm-6">
												<div class="list_product_content">
													...
													<div class="add_links">
														<ul>
															<li><a href="#" title="Thêm Vào Giỏ Hàng"><i
								...
								<div class="pagination_style shop_page">
									<div class="item_page">
										<form action="#">
											<label for="page_select">Hiển Thị</label> <select
												id="page_select">
												<option value="1">9</option>
												<option value="2">10</option>
												<option value="3">11</option>
											</select> <span>Sản Phẩm Theo Trang</span>
										</form>
									</div>
								...
								<div class="row">
									<div class="col-lg-3 col-md-6 col-sm-6">
										<div id="lienHe" class="footer_widget">
											<h3>Chúng Tôi</h3>
											<p>Khám phá hương thơm quyến rũ từ Ngọc Bình Perfume -
												nơi mỗi giọt nước hoa là sự kết hợp hoàn hảo giữa nghệ thuật
												và khoa học, giúp bạn tự tin tỏa sáng và bộc lộ phong cách
												riêng.</p>
								...
								<div class="row align-items-center">
									<div class="col-lg-6 col-md-6">
										<div class="copyright_area">
											...
											<p>
												Bản quyền &copy; 2024 <a href="#">Perfume</a>. Đã đăng ký
												bản quyền.
											</p>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="footer_social text-right">
											<ul>
												<li><a href="https://www.facebook.com/wildhorse9"><i
